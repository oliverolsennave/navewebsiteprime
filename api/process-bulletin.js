      ...
      const messages = [
        {
          ...
          content: [
            {
              type: 'text',
              text: `Extract parish information from this church bulletin. Return ONLY valid JSON with no markdown formatting:\n{\n  "pastorName": "",\n  "email": "",\n  "phone": "",\n  "address": "",\n  "city": "",\n  "state": "",\n  "zipCode": "",\n  "website": "",\n  "description": "",\n  "massSchedule": {\n    "Sunday": [{ "time": "8:00 AM", "language": "English" }],\n    "Monday-Friday": [{ "time": "7:00 AM", "language": "English" }]\n  },\n  "confessionSchedule": {\n    "Saturday": [{ "time": "3:00 PM", "endTime": "4:30 PM", "language": "" }]\n  },\n  "adorationSchedule": {\n    "Monday-Friday": [{ "time": "6:00 PM", "endTime": "9:00 PM" }]\n  },\n  "upcomingEvents": [\n    { "title": "", "date": "Feb 18", "time": "6:30 PM", "location": "", "description": "" }\n  ],\n  "pastorPSAs": ""\n}\nValid day keys: "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Monday-Friday". Use 12-hour time format like "8:00 AM", "12:30 PM". For confession/adoration ranges use separate "time" (start) and "endTime" (end) fields. Use empty string for string fields not found. Return empty objects {} for schedules with no data. Return empty array [] for no events. For event dates use "MMM d" format (e.g. "Feb 18", "Mar 7"). For event times use 12-hour format (e.g. "6:30 PM"). Include event location/venue if mentioned. IMPORTANT — upcomingEvents extraction rules:\n- Events are distinct gatherings with a specific date or time that parishioners are invited to attend. Examples: fish fries, retreats, fundraisers, classes, meetings, bible studies, prayer groups, volunteer drives, pilgrimages, concerts, dinners, dances, speakers, workshops, registration deadlines.\n- Do NOT include recurring Mass, confession, or adoration schedules as events (those go in the schedule fields).\n- Err on the side of including MORE events rather than fewer. If something looks like it could be an event with a date/time and an invitation to attend, include it.\n- Extract every single one — do not skip, merge, or summarize.\n- For each event description, write at least three sentences in the warm, inviting tone of a parish staff member who is excited for parishioners to attend. Use details from the bulletin but make it feel personal and welcoming.`,
            },
            fileContent,
          ],
        },
